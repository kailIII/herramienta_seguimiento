...
01 Abr 2003; Ajustado al espagnol (Carlos Rodræguez)
...
var g_startDay = 0// 0=Domingo, 1=lunes

// preload images

var imgUp = new Image(8,12);

imgUp.src = '/graficas/up.gif';

var imgDown = new Image(8,12);

imgDown.src = '/graficas/down.gif';
...
tmp.focus();
	  ...
	  var delim = eval('/\\' + this.dateDelim + '/g');
	   ...
	   switch (this.dateFormat.replace(delim,"")){
	     ...
	     case  'yyyymmdd': return year + this.dateDelim + padZero(month+1) + this.dateDelim + padZero(day);
	              ...
	              default: alert('Formato de Fecha no disponible');
	...
	window.onload=function(){ 
	  ...
	  if (browser.ns4){
	    ...
	    if (typeof document.NSfix == 'No valido'){
    ...
    window.onerror = function(msg,url,line){
	  ...
	  + '\n\n1)Se haya adicionado programacion en el evento ONLOAD del BODY,'

	  + '\nsi se quiere ejecutar algo al igual que la inicializacion del calendario'

	  + '\n se debe adicionar el evento ONLOAD en la libreria del calendario.'

	  + '\n\n2)No haya colocado correctamente los parametros en el metodo g_Calendar.show() '

	  + '\n\nVer www.totallysmartit.com\\examples\\calendar\\simple.asp for examples'
